 ...
 * <h1>Python</h1>
 *
 * <p>Compile or interpret a Python source program.</p>
 *
...
public class Python
{
    ...
    /**
     * Compile or interpret a Python source program.
     * @param operation either "compile" or "execute".
     * @param filePath the source file path.
     * @param flags the command line flags.
     */
    public Python(String operation, String filePath, String flags)
    {
        try {
            ...
            parser = FrontendFactory.createParser("Python", "top-down", source);
    ...
    private static final String USAGE =
        "Usage: Python execute|compile " + FLAGS + " <source file path>";
    ...
    public static void main(String args[])
    {
        try {
            ...
            if (i < args.length) {
                String path = args[i];
                new Python(operation, path, flags);
            }
            else {
                throw new Exception();
            }
