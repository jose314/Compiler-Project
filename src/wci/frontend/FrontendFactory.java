...
import wci.frontend.python.PythonParserTD;
import wci.frontend.python.PythonScanner;
...
public class FrontendFactory
{
        ...
        throws Exception
    {
        ...
        else if (language.equalsIgnoreCase("Python") && type.equalsIgnoreCase("top-down"))
        {
            Scanner scanner = new PythonScanner(source) ;
            return new PythonParserTD(scanner) ;
        }
        else if (!language.equalsIgnoreCase("Pascal") && (!language.equalsIgnoreCase("Python")))
        {
