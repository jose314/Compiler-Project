...
import static wci.frontend.python.PythonErrorCode.TOO_MANY_ERRORS;
import static wci.message.MessageType.SYNTAX_ERROR;

/**
 * <h1>PythonErrorHandler</h1>
 *
 * <p>Error handler Python syntax errors.</p>
 *
 * <p>Copyright (c) 2009 by Ronald Mak</p>
 * <p>For instructional purposes only.  No warranties.</p>
 */
public class PythonErrorHandler
{
     ...
     */
    public void flag(Token token, PythonErrorCode errorCode, Parser parser)
    {
     ...
     * @param parser the parser.
     */
    public void abortTranslation(PythonErrorCode errorCode, Parser parser)
    {
